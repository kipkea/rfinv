...
class BarcodeService:
    ...
    def detect_and_decode(self, frame):
        ...
        detections = decode(frame, symbols=[ZBarSymbol.QRCODE, ZBarSymbol.CODE128, ZBarSymbol.EAN13, ZBarSymbol.EAN8, ZBarSymbol.UPCA, ZBarSymbol.UPCE, ZBarSymbol.CODE39])

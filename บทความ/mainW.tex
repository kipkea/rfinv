...
\newfontfamily\thaifont{TH Sarabun New} % บรรทัดนี้สำคัญมาก เพื่อให้ TikZ เรียกใช้ได้
...
\textit{ภาควิชาวิทยาการคอมพิวเตอร์, มหาวิทยาลัยเชียงใหม่} \\
...
\begin{keywords}
RFID, Cloud Technology, Imventory, Raspberry Pi
\end{keywords}

...
\begin{tikzpicture}[node distance=2cm and 2.5cm] % ปรับระยะห่างระหว่างโหนด (แนวตั้ง and แนวนอน)
    ...
    \begin{pgfonlayer}{background}
        ...
        % กรอบโซนคลาวด์
        \node [draw=orange!50, dashed, fill=orange!5, fit=(ec2) (rds), label={[anchor=north east, font=\bfseries\small, xshift=-0.5cm, yshift=-0.5cm]north east:Zone 2: AWS Cloud (คลาวด์)}, inner sep=0.8cm, rounded corners] (zone2) {};
    \end{pgfonlayer}

\end{tikzpicture}
\caption{แผนภาพสถาปัตยกรรมระบบ แสดงการเชื่อมโยงจาก Raspberry Pi 5 ผ่านอินเทอร์เน็ตไปยัง Django API บน AWS Cloud}

...
% สร้างคำสั่งสำหรับฟอนต์ภาษาไทยใน TikZ เพื่อความชัวร์
\newfontfamily\thaifont{TH Sarabun New}[Scale=1.25]

\begin{document}

\begin{tikzpicture}[
    node distance=2.5cm,
    % เปลี่ยนจาก \sffamily เป็นการกำหนดฟอนต์หลักที่รองรับภาษาไทย
    every node/.style={font=\thaifont}, 
    device/.style={
        rectangle, 
        draw=gray!60, 
        thick, 
        ...
        fill=white, 
        align=center, 
        minimum width=3cm, % ขยายขนาดนิดหน่อยให้รองรับภาษาไทย
        minimum height=2cm,
        drop shadow
    },
    cloud_node/.style={

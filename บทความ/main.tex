...
\begin{table}[h!]
    \centering
    \caption{คุณสมบัติของ RFID ID Tag [9]}
    \label{tab:rfid-tag}
    \vspace{0.2cm}
...
\begin{figure}[h!]
    \centering
    % ปรับขนาดรูปตรง width (เช่น 0.6 คือ 60% ของความกว้างหน้ากระดาษ)
    \includegraphics[width=0.4\textwidth]{pictures/rfid-tag.png}
    \caption{RFID Tag}
    \label{fig:rfid-tag}
\end{figure}
% --- จบส่วนแทรกรูปภาพ ---

    \item \textbf{Raspberry Pi 5:} ใช้เป็นหน่วยประมวลผลหลักในการควบคุมอุปกรณ์อ่าน RFID โดยทำการสื่อสารระหว่าง RFID Module (FM-505) และ Raspberry Pi 5 ผ่านทาง Protocol UART (Universal Asynchronous Receiver/Transmitter) และ จัดเก็บข้อมูลไว้ที่ระบบคลาวด์บน Amazon AWS โดยการสื่อสารเชื่อมโยงข้อมูลผ่านทาง API ที่พัฒนาด้วยภาษา Python [2]

% --- เริ่มส่วนแทรกรูปภาพ ---
\begin{figure}[h!]
    \centering
    % ปรับขนาดรูปตรง width (เช่น 0.6 คือ 60% ของความกว้างหน้ากระดาษ)
    \includegraphics[width=0.4\textwidth]{pictures/pi5.png}
    \caption{Raspberry Pi 5 8GB}
    \label{fig:pi5}
\end{figure}
% --- จบส่วนแทรกรูปภาพ ---

    \item \textbf{Cloud Technology (AWS):} ใช้บริการ EC2 สำหรับติดตั้ง Server และ จัดเก็บฐานข้อมูล โดยมี API ทำหน้าเชื่อมต่อระหว่างอุปกรณ์และ AWS [4]
    \item \textbf{Django Framework:} ใช้พัฒนา Web API ด้วยภาษา Python ประกอบด้วยการอ่านและบันทึกข้อมูลลงฐานข้อมูลบนคลาวด์ เพื่อมาใช้งานในชุดอ่าน RFID หรือ เครื่อง Client เช่น มือถือ และ คอมพิวเตอร์  [3]
    \item \textbf{Kivy : Cross-platform Python Framework for apps Development:} ใช้ในการออกแบบหน้าจอ GUI ที่ใช้ควบคุมอุปกรณ์และบริหารสินค้าคงคลังทั้งหมด [11]
\end{enumerate}
...
\begin{figure}[h!]
    ...
    %\input{graphs/rfinv_diagram.tex} 
...
\rowcolor{lightgray} 
\textbf{หัวข้อเปรียบเทียบ} & \textbf{ระบบ Barcode หรือ QR-Code}  \\ \hline
ต้นทุนต่อหน่วย  & ต่ำมาก  \\ \hline
ต้นทุนอุปกรณ์อ่าน & ราคาถูก หาซื้อง่าย \\ \hline
อายุการใช้งาน & สั้น ชำรุด เลือนได้ง่าย  \\ \hline
ต้นทุนด้านแรงงาน & สูง ต้องทำการตรวจทีละชิ้น  \\ \hline
ความแม่นยำของข้อมูล & มีโอกาสผิดพลาดจากผู้ใช้  \\ \hline
\end{tabular}
\caption{ตารางแสดงข้อมูลที่ใช้ระบบ Barcode หรือ QR-Code }
\end{table}

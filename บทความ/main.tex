...
% สูตรหาค่าเฉลี่ย
\subsection{สูตรหาค่าเฉลี่ยเวลาในการอ่าน (Average Time)}
\begin{equation}
    \bar{t} = \frac{\sum_{i=1}^{n} t_i}{n}
\end{equation}
โดยกำหนดให้:
\begin{itemize}
    \item $\bar{t}$ คือ เวลาเฉลี่ย (วินาที)
...
โดยกำหนดให้:
\begin{itemize}
    \item $Speed$ คือ ความเร็วในการอ่าน (รหัส/วินาที)
    \item $N$ คือ จำนวนรหัสสินค้า (5, 10, 30, 50, 100 ชิ้น)
